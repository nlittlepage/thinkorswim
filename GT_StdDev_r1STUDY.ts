...
RelVol.SetPaintingStrategy(PaintingStrategy.LINE);
RelVol.SetLineWeight(2);
RelVol.DefineColor("Above", Color.RED);
RelVol.DefineColor("Below", Color.GREEN);
RelVol.AssignValueColor(if RelVol >= posDev then RelVol.Color("Above") else RelVol.Color("Below"));
RelVol.HideBubble();
...
PriceStdDev.SetPaintingStrategy(PaintingStrategy.LINE);
